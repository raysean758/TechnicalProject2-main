    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className='w-full max-w-3xl p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700 mx-auto my-3'>
                 <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">                <TextInput Label="Category Title"
                name="title"
              ...
              <div className="mt-6 sm:col-span-1">
                {loading ? (
                    ...
                    disabled
                    type="button"
                    className="text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline"
                    >
                        <svg
                        aria-hidden="true"
                        role="status"
                    ...
                    <button
                    type="submit"
                    className='inline-flex items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium'>
